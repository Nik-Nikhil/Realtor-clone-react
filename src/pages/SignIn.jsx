    ...
    <section>
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        <form>
          ...
          <button className="w-full bg-indigo-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-indigo-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-indigo-800" type="submit">Sign In</button>
